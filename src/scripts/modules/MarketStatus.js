...
class MarketStatus {
  constructor() {
    ...
    this.coinsURL = `https://api.nomics.com/v1/currencies/ticker?key=${APIKey}&1d`
    this.marketCapUrl = `https://api.nomics.com/v1/market-cap/history?key=${APIKey}&start=${this.yesterdaysDate}T${this.currentHour}%3A59%3A59.999Z`
    this.volumeUrl = `https://api.nomics.com/v1/volume/history?key=${APIKey}&start=${this.yesterdaysDate}T${this.currentHour}%3A59%3A59.999Z`
